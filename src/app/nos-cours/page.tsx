  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <SectionHeading eyebrow="Cours" title="Nos cours">
        Voici la liste des cours proposés par la Gym de Gimel. Vous pouvez
        filtrer les cours par catégorie, âge et jour de la semaine. Pour plus
        d'informations sur un cours, cliquez sur le bouton "Voir le cours" du
        cours correspondant.
      </SectionHeading>
