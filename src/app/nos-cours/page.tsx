...
export const metadata: Metadata = {
    title: "Nos cours",
    description:
        "Tous les cours de la Gym de Gimel avec filtres par catégorie, âge et jour.",
};
    ...
    return (
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <SectionHeading eyebrow="Cours" title="Nos cours">
                Voici la liste des cours proposés par la Gym de Gimel. Vous
                pouvez filtrer les cours par catégorie, âge et jour de la
                semaine. Pour plus d'informations sur un cours, cliquez sur le
                bouton "Voir le cours" du cours correspondant.
            </SectionHeading>

            <form
                className="mt-8 grid gap-4 rounded-lg border border-stone-200 bg-white p-4 shadow-soft md:grid-cols-4"
                action="/nos-cours"
            >
